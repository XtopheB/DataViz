...
\subtitle{\textcolor{siap}{\large{Data Visualization}}}
\author{Christophe Bontemps}
\institute{\large{\textit{Statistical Institute for Asia and the Pacific} } \\
...
\begin{frame}
\begin{center}
\textcolor{brique}{{\huge H\includegraphics[height=0.4cm]{LieRed.png}w  \textcolor{brique}{[Not]} To Lie With Graphics?}}
...
\vspace{0.5cm}
\large{\textcolor{brique}{( \textit{Do you remember from e-learning?})}}
\end{center}
\end{frame}
...
\begin{itemize}
  ...
  \only<1>{ \includegraphics[width = 0.7\textwidth]{FossilFuel_and_Cement_emissions_1959.png}}
\end{itemize}
\end{center}
\end{frame}
...
\begin{itemize}
  ...
  \only<1>{ \includegraphics[width = 0.8\textwidth]{DesignNumbers-18.png}}
  \only<2>{ \textcolor{brique}{\textbf{lines}... } \\ \vspace{0.5cm} }
  \only<2>{}
  \only<2>{ \includegraphics[width = 0.8\textwidth]{LCRost-dualaxis1.png}}
  \only<3>{\textcolor{brique}{\textbf{lengths}...} \\ }
  \only<3>{ \includegraphics[width = 0.8\textwidth]{BBC-EUElectionOriginal.jpg}}
  \only<4>{\textcolor{brique}{\textbf{colors}...}  \\ }
  \only<4>{ \includegraphics[width = 0.35\textwidth]{GermanElectionsSPD.JPG}}
\end{itemize}
\end{center}
\end{frame}
...
\begin{itemize}
  \item<+->[]
   \only<2> {\includegraphics[width = 0.6\textwidth]{ChipsBags0.jpg}}
   \only<3> {\includegraphics[width = 0.6\textwidth]{ChipsBags1.jpg}}
   \end{itemize}
\end{frame}
...
\begin{itemize}
  \item<+->[]
   \only<2> {\includegraphics[width = 0.8\textwidth]{PhotoLineZoomed.jpg}\\ }
   \only<3> {\includegraphics[width = 0.8\textwidth]{PhotoLineDeZoomed.jpg}\\ }
...
%\begin{itemize}
%  \item<+->[]
%  \only<2>{\includegraphics[width = 0.6\textwidth, height = 0.45\textwidth]{Cumulative-iphone-sales.jpg} \\ }
%  \only<3>{\includegraphics[width = 0.6\textwidth, height = 0.45\textwidth]{Cumulative-iphone-sales-rectified2.png}\\}
...
\begin{center}
\begin{itemize}
  \only<1>{ \includegraphics[width = 0.8\textwidth]{BarsNYC.jpeg} \\ }
  \only<2>{ \includegraphics[width = 0.6\textwidth]{BarsNYC-zoom.jpeg} \\ }
  \only<3>{ \textbf{Initial} version \\ }
  \only<3>{ \includegraphics[width = 0.8\textwidth]{BarsNYC.jpeg} \\ }
  \only<4>{ \textbf{Correct} version \\ }
  \only<4>{ \includegraphics[width = 0.7\textwidth]{BarsNYC-Corrected.jpeg} \\ }
...
%  \only<5>{ \includegraphics[width = 0.8\textwidth]{BarsNYC-long.jpeg} \\ }
...
%  \only<1>{ \includegraphics[width = 0.9\textwidth]{Mistake-barchart.jpg} \\ }
...
%  \only<2>{ \includegraphics[width = 0.7\textwidth]{XAxisScaleChange.JPG} \\  }
%  \only<2>{\textcolor{gris}{\footnotesize{Source: My 2017' students (Jan \& Mohamed)}}   }
%  \only<3>{\textbf{Published example} are common! \\ }
%%  \only<3>{ \includegraphics[width = 0.5\textwidth]{Lie-X-Axis-Covid.png}}
%%  \only<4>{ \includegraphics[width = 0.7\textwidth]{Lie-X-Axis-Covid-Zoom.png}}
% \only<3>{ \includegraphics[width = 0.9\textwidth]{ Axe_palaeotemps.png}}
...
%  \only<1>{ \includegraphics[width = 0.7\textwidth]{TruncatingAxis-BarsBad-Correll2019.JPG}}
%  \only<2>{This is good: \\}
%  \only<2>{ \includegraphics[width = 0.7\textwidth]{TruncatingAxis-BarsGood-Correll2019.JPG}}
%  \only<3>{This is also bad:\\ }
%  \only<3>{ \includegraphics[width = 0.8\textwidth]{ExperienceTruncatingAxis-Bars-Correll2019.JPG}}
%  \only<4>{Bad or good? \\ }
%  \only<4>{ \includegraphics[width = 0.8\textwidth]{ExperienceTruncatingAxis-Lines-Correll2019.JPG}}
...
% \includegraphics[width = 0.4\textwidth]{ExperienceTruncatingAxis-Bars-Correll2019.JPG} \includegraphics[width = 0.4\textwidth]{ExperienceTruncatingAxis-Lines-Correll2019.JPG}}
%  \only<6>{Bad? \\ }
%  \only<6>{ \includegraphics[width = 0.75\textwidth]{AverageGlobalTemperature-Truncated.JPG}\\ }
%  \only<6>{\textcolor{gris}{\footnotesize{\href{https://en.wikipedia.org/wiki/Misleading_graph}{Washington Post (December, 2015)}}}}
%  \only<7>{Good? \\ }
%  \only<7>{ \includegraphics[width = 0.8\textwidth]{AverageGlobalTemperature-Misleading.JPG}\\ }
...
%  \only<1>{ \includegraphics[width = 0.8\textwidth]{TruncatingAxis-All-Correll2019.JPG}}
...
%  \only<3> {\includegraphics[width = 1.0\textwidth]{MisleadingScales-Duff.JPG} \\}
...
\begin{itemize}
  ...
  \only<1>{ \includegraphics[width = 0.8\textwidth]{Line_graph1.png}}
  \only<2>{The same with a different \textbf{Y}-axis... }
  \only<2>{ \includegraphics[width = 0.8\textwidth]{Line_graph3.png}}
  \only<3>{The same with a \textbf{Y}-axis that goes way beyond max(Y)... }
  \only<3>{ \includegraphics[width = 0.8\textwidth]{Line_graph2.png}}
\end{itemize}
\end{center}
\textcolor{gris}{\footnotesize{Source: \href{https://en.wikipedia.org/wiki/Misleading_graph}{Wikipedia: Misleading graph}}}
\end{frame}
...
\begin{center}
\begin{itemize}
  \only<1>{ \includegraphics[width = 0.8\textwidth]{Lie-WhiteHouse.png} \\ }
  \only<2>{ \includegraphics[width = 0.8\textwidth]{Lie-WhiteHouse-zoom.jpg} \\ }
  \only<3>{ \textbf{Initial} version \\ }
  \only<3>{ \includegraphics[width = 0.8\textwidth]{Lie-WhiteHouse.png} \\ }
  \only<4>{ \textbf{Correct} version \\ }
  \only<4>{ \includegraphics[width = 0.8\textwidth]{Lie-WhiteHouse-correct.jpg} \\ }
...
\begin{itemize}
  ...
  \only<2>{ \includegraphics[width = 0.4\textwidth]{Line_graph1-3.png}}
  \only<3>{The same with a widespread \textbf{X}-axis and a short \textbf{Y}-axis }
  \only<3>{ \includegraphics[width = 0.8\textwidth]{Line_graph1-4.png}}
\end{itemize}
\end{center}
\textcolor{gris}{\footnotesize{Source: \href{https://en.wikipedia.org/wiki/Misleading_graph}{Wikipedia: Misleading graph}}}
\end{frame}
...
\begin{itemize}
\item[]
  \only<1>{\includegraphics[width =0.3\textwidth]{john-hopkins-confirmed-cases-coronavirus.png} \\ }
  ...
  \only<2>{\includegraphics[width =0.9\textwidth]{john-hopkins-confirmed-cases-coronavirus2.png} \\ }
...
\begin{center}
\begin{itemize}
  \only<1>{\includegraphics[width = 0.75\textwidth]{SpuriousCorrelations.JPG} \\ }
...
%  \only<1>{ \includegraphics[width = 0.9\textheight]{Swanson-Dementia.JPG}}
%  \only<2>{Glyphosate \textit{vs} Tyroid\\ }
%  \only<2>{ \includegraphics[width = 0.9\textheight]{Swanson-Tyroid.JPG}}
%  \only<3>{Glyphosate \textit{vs} Parkinson\\ }
%  \only<3>{ \includegraphics[width = 0.9\textheight]{Swanson-Parkinson.JPG}}
%  \only<4>{Glyphosate \textit{vs} Diabetes\\ }
%  \only<4>{ \includegraphics[width = 0.9\textheight]{Swanson-Diabetes.JPG}}
%  \only<5>{Glyphosate \textit{vs} Strokes\\ }
%  \only<5>{ \includegraphics[width = 0.9\textheight]{Swanson-Stroke.JPG}}
%  \only<6>{Glyphosate \textit{vs} Hypertension\\ }
%  \only<6>{ \includegraphics[width = 0.9\textheight]{Swanson-Hypertension.JPG}}
%\end{itemize}
%\end{center}
...
\begin{center}
\begin{itemize}
  \only<1>{ \includegraphics[width = 0.55\textwidth]{GBP-USDRate-Brexiters.JPG} \\ }
  \only<2>{ \includegraphics[width = 0.8\textwidth]{GBP-USDRate-Brexiters-Zoom.jpg} \\ }
  \only<1-2>{\textcolor{gris}{\footnotesize{Source: \href{http://facts4eu.org/news_dec_2017.shtml}{Pro-Brexit site( Facts4eu.org)}}} }
  \only<3>{ \includegraphics[width = 0.8\textwidth]{GBP-USDRate-5Y.JPG}}
  \only<4>{ \includegraphics[width = 0.8\textwidth]{GBP-USDRate-5Y-Annotated.jpg}}
  \only<5>{ \includegraphics[width = 0.8\textwidth]{GBP-USDRate-10Y.JPG}}
  \only<6>{ \includegraphics[width = 0.8\textwidth]{GBP-USDRate-10Y-Annotated.jpg}}
\end{itemize}
\end{center}
\end{frame}
...
\begin{center}
\begin{itemize}
 % \only<1>{\includegraphics[width =0.7\textwidth]{FoxPieChart.jpg} \\}
%  \only<1>{\textcolor{gris}{\footnotesize{From \href{https://www.nbcchicago.com/news/local/FOX-News-Chart-Fails-Math-73711092.html}{FOX News}}}}
  \only<1>{\includegraphics[width =0.8\textwidth]{PieChartLiesCovid19.jpg} \\}
...
\begin{center}
\begin{itemize}
  \only<1-2>{ \includegraphics[width =0.9\textwidth]{Compare3Pies.png} }
  \only<2>{ \hfill \textcolor{brique}{ \textbf{Poll}} }
  \only<3>{ \includegraphics[width =0.65\textwidth]{Compare3BarsV.png} \\}
  \only<4>{ \includegraphics[width =0.65\textwidth]{Compare3BarsH.png} \\}
  \only<5>{ \includegraphics[width =0.65\textwidth]{Compare3PiesBars.png} \\}
  \only<6>{ \includegraphics[width =0.65\textwidth]{Compare3PiesBarsH.png} \\}
...
\begin{itemize}
  ...
  \only<1>{ \includegraphics[width =0.95\textwidth]{PizzaCirclesNolegend.jpg} }
  \only<2>{ One big $ >$  two smaller pizzas! \\}
  \only<2>{ \includegraphics[width =0.95\textwidth]{PizzaCircleslegend.jpg} \\}
  \only<3>{ \includegraphics[width =0.9\textwidth]{BubbleMap.png} }
...
\begin{itemize}
  ...
  \only<1>{ \includegraphics[width =0.9\textwidth]{PrisonniersUSABlind-EN.jpg} }
  \only<2>{ \includegraphics[width =0.9\textwidth]{PrisonniersUSA-EN.jpg} \\ }
  \only<3>{ \includegraphics[width =0.9\textwidth]{BubbleMapSquares.png} }
...
\begin{itemize}
  ...
  \only<1>{\includegraphics[width = 0.32\textwidth]{BarsClevelandUnFramed.jpg}}
  \only<2>{\includegraphics[width = 0.32\textwidth]{BarsClevelandFramed.jpg}}
  \only<1-2>{\textcolor{gris}{\footnotesize{Source: \cite{Cleveland1984}}} \hfill \textcolor{brique}{\textbf{Poll}} }
  \only<3>{ \includegraphics[width =0.9\textwidth]{BubbleMapBars.png} }
  \only<4>{ \includegraphics[width =0.65\textwidth]{PEllisGaugeMap.png} }
\end{itemize}
\end{center}
\end{frame}
...
%\begin{figure}
%\href{http://bl.ocks.org/marcdhansen/1ace92ea6344aa05bbac}{\includegraphics[width = 0.95\textwidth]{InteractiveHistograms-0.jpg}}
...
%\begin{figure}
%\href{http://bl.ocks.org/marcdhansen/1ace92ea6344aa05bbac}{\includegraphics[width=0.4\textwidth]{FruitsSales1.jpg}}
%\href{http://bl.ocks.org/marcdhansen/1ace92ea6344aa05bbac}{\includegraphics[width=0.4\textwidth]{FruitsSales2.jpg}} \\
%\href{http://bl.ocks.org/marcdhansen/1ace92ea6344aa05bbac}{\includegraphics[width=0.4\textwidth]{FruitsSales3.jpg}}
%\href{http://bl.ocks.org/marcdhansen/1ace92ea6344aa05bbac}{\includegraphics[width=0.4\textwidth]{FruitsSales4.jpg}}
...
%\begin{enumerate}
%   \item<+->[]\includegraphics[width = 0.65\textwidth]{Curves1.pdf}
%   \item<+->[]\includegraphics[width = 0.65\textwidth]{curves1-diff.pdf}
...
%\begin{enumerate}
%   \item[]
%\only<1>{\includegraphics[width = 0.6\textwidth]{Lines-Cairo.jpg}}
%\only<2>{\includegraphics[width = 0.6\textwidth]{Lines-Cairo-diff.jpg}}
...
%\frametitle{\textcolor{brique}{[- \textbf{Rule \#6bis: Compare lines}  -]}}
%\begin{enumerate}
%   \item<+->[]\includegraphics[width = 0.3\textwidth]{Lines-Cairo.jpg}
%   \item<+->[]\includegraphics[width = 0.3\textwidth]{Lines-Cairo-diff.jpg}
...
% \begin{itemize}
% \item<+->[] \includegraphics[width = 1.0\textwidth]{MunznerLinesClassic.pdf}
% \item <+-> What do you see here ?
% \item<+->[] \includegraphics[width = 1.0\textwidth]{MunznerLinesMultiples.pdf}
% \item<+->[] Easier to see the trend of each curve...
%  \item<+->[] Idea shared by \cite{Gelman2004}  and \cite{Munzner2014}  %\includegraphics[width = 0.5\textwidth]{Buja-Exemple2.pdf}
% \end{itemize}
%\end{frame}
%
...
\begin{center}
\begin{enumerate}
   \only<1>{\includegraphics[width = 0.5\textwidth]{Radar1.png}\includegraphics[width = 0.5\textwidth]{Radar-Bars1.png}}
   \only<2>{\includegraphics[width = 0.5\textwidth]{Radar2.png}\includegraphics[width = 0.5\textwidth]{Radar-Bars2.png}}\\
\end{enumerate}
\end{center}
\textcolor{gris}{\footnotesize{Source: \href{http://data.visualisation.free.fr/Blog/Why-you-should-never-use-radar-plots.nb.html}{Xtophe's blog: Why you should never use radar plots}}}
\end{frame}
...
\begin{center}
\begin{itemize}
    \only<1>{ \includegraphics[width =0.9\textwidth]{BubbleMapChoropleth.png} }
    \only<2>{ \includegraphics[width =0.9\textwidth]{BubbleMap.png} }
    \only<3>{ \includegraphics[width =0.9\textwidth]{BubbleMapSquares.png} }
    \only<4>{ \includegraphics[width =0.9\textwidth]{BubbleMapBars.png} }
    \only<5>{ \includegraphics[width =0.55\textwidth]{PEllisGaugeMap.png} \\ }
    \only<5>{ One solution: Use a \emph{gauge map} (P. Ellis) }
    \only<6>{ \includegraphics[width =0.65\textwidth]{MenInParliament.png}\\ }
    \only<6>{ Another solution: Visualize \textbf{Men} in parliament }
    \only<7>{ \includegraphics[width =0.40\textwidth]{MenInParliament.png} \includegraphics[width =0.50\textwidth]{MenInParliamentBarChart.png} \\ }
    \only<7>{ Another another solution: Use \textbf{both} a map and Bars }
...
%\begin{itemize}
% \item[]
%\only<1>{\includegraphics[width = 0.8\textwidth]{BerlinSubwayMap.JPG}}
%\only<2>{\includegraphics[width = 0.8\textwidth]{BerlinSubway.jpg}}
%\end{itemize}
%\end{center}
%
...
Maybe spatial information is not the most relevant!
\begin{center}
\includegraphics[width=0.4\textwidth]{USElectionChanges.JPG}   \hspace{0.5cm} \includegraphics[width=0.3\textwidth]{Updated-what-happened.png}
\end{center}
...
\begin{enumerate}
   \only<1>{Original}
   \only<1>{\includegraphics[width = 1.0\textwidth]{BarsElectionsLCI.jpg}}
   \only<2>{Corrigé}
   \only<2>{\includegraphics[width = 1.0\textwidth]{BarsElectionsLCIModif.jpg}}\\
\end{enumerate}
\end{center}
\end{frame}
...
\begin{enumerate}
   \only<1>{Original}
   \only<1>{\includegraphics[width = 1.0\textwidth]{PopulariteMacron.jpg}}
   \only<2>{Corrigé}
   \only<2>{\includegraphics[width = 1.0\textwidth]{PopulariteMacronCorrigeNBoeuf.jpg}}
\end{enumerate}
\end{center}
\end{frame}
...
\begin{enumerate}
   \only<1>{Original}
   \only<1>{\includegraphics[width = 1.0\textwidth]{BBC-EUElectionOriginal.jpg}}
   \only<2>{Détection}
   \only<2>{\includegraphics[width = 1.0\textwidth]{BBC-EUElectionLie2.jpg}}
   \only<3>{Correction}
   \only<3>{\includegraphics[width = 1.0\textwidth]{BBC-EUElectionCorrected1.jpg}}
   \only<4>{Vérification}
   \only<4>{\includegraphics[width = 1.0\textwidth]{BBC-EUElectionCorrected3.jpg}}
\end{enumerate}
\end{center}
\end{frame}
...
\begin{enumerate}
   \only<1>{Original}
   \only<1>{\includegraphics[width = 0.6\textwidth]{IndianPrimeMinisterPetrol2018.jpg}}
   \only<2>{LOL !}
   \only<2>{\includegraphics[width = 0.6\textwidth]{IndianPrimeMinisterPetrol2018_Lol.jpg}}
   \only<3>{Correction?}
   \only<3>{\includegraphics[width = 0.6\textwidth]{IndianPrimeMinisterPetrol2018_Corrected.jpg}}
   \only<4>{Justification!}
   \only<4>{\includegraphics[width = 0.6\textwidth]{IndianPrimeMinisterPetrol2018_Corrected2.jpg}}
   \only<5>{LOL !}
   \only<5>{\includegraphics[width = 0.8\textwidth]{IndianPrimeMinisterPetrol2018_Lol2.jpg}}
\end{enumerate}
\end{center}
\end{frame}
